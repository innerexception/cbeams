...
export default () => {
  ...
  return (
    <div style={{ position: 'relative', height: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {activeModal && activeModal !== Modal.Briefing && <div style={{ position: 'absolute', height: 'fit-content', width: '500px', left: 0, right: 0, bottom: 0, top: 0, margin: 'auto', zIndex: 1 }}>{getModal()}</div>}
