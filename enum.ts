...
export const ShipData:Record<ShipType, ShipStats> = {
    ...
    [ShipType.MLRS]: { name:'MLRS', speed:20, sightRadius:200, armor:0, hp:15, damage:5, cooldownMs:1500, rangePx:350, sizeHex:1, productionTimeMs:12000, logisticsCost:2, ammo:10, metalCost:1 },
    [ShipType.AWACS]: { name:'AWACS', speed:20, sightRadius:600, armor:0, hp:15, damage:0, cooldownMs:0, rangePx:0, sizeHex:1, productionTimeMs:12000, logisticsCost:3, metalCost:1 },
