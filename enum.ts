...
export const BuildingData:Record<BuildingType,BuildingMetaData> = {
    ...
    [BuildingType.BLM]: { maxHp:40, cooldownMs:10000, damage:5, rangePx:4000, logisticsCost:3, buildingPoints:3 },
    [BuildingType.THADD]: { maxHp:40, cooldownMs:10000, damage:0, rangePx:600, logisticsCost:3, buildingPoints:4 },
}
