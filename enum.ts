...
export const ShipData:Record<ShipType, ShipStats> = {
    ...
    // Unarmed — it has no weapon at all now, only its Objective-latching behavior (see ShipData's
    // latchedObjectiveId/objectiveAttached in types.d.ts, and MapScene's moveShips/updateObjectives).
